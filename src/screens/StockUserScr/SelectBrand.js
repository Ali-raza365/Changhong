...
const SelectBrand = (props) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: COLOR.whiteColor }}>
            <Image source={IMAGE.logo} style={{}} resizeMode="contain" />
            <Text
                style={{
                    position: 'absolute',
                    top: 0,
            ...
            <SearchComponent placeholder="Search..."
                bgcolorr={{ backgroundColor: COLOR.whiteColor }}
                containerStyle={{ backgroundColor: COLOR.offWhite }}
            ...
            <Tabs totalTabs="2"
                containerStyle={{ backgroundColor: COLOR.whiteColor, borderRadius: WP(2) }}
                innerStyle={{ borderRadius: WP(2), backgroundColor: COLOR.offWhite }}
                tabStyle={{ backgroundColor: COLOR.primary, borderRadius: WP(2) }}
            ...
            {active == 0 &&
                <FlatList
                    data={stocks.length !== 0 ? stocks.shop_stock[0].subs : []}
                    // data={[]}
                    ...
                    renderItem={({ item, index }) => {
                        return (
                            <TouchableOpacity
                                onPress={() => {
                                    navigation.navigate('StockDetails', { _data: item.products, name: item.name });
                                }}
                                accessible={true}
                                style={{
                                    position: 'relative',
            ...
            {active == 1 &&
                <FlatList
                    data={stocks.length !== 0 ? stocks.shop_stock[1].subs : []}
                    contentContainerStyle={{
                        backgroundColor: COLOR.whiteColor,
                    }}
                    keyExtractor={(item, index) => 'home-item' + index.toString()}
